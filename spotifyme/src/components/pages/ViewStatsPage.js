...
export default function PlaylistPage() {
	...
	const [topSelected, setTopSelection] = useState("tracks");
	const [timeSelected, setTimeSelection] = useState("short_term");
	...
	const getTracks = () => {
		spotifyApi.getMyTopTracks(
			{ limit: 50, time_range: timeSelected },
			function (err, data) {
				if (err) {
						...
						<ICard
							...
							<Stack
								...
								<SelectionGroup
									value={topSelected}
									exclusive
									onChange={(event, newTopSelection) => {
										if (newTopSelection !== null) {
											setTopSelection(newTopSelection);
										}
									}}
									aria-label="stat selction">
									<SelectionButton value="tracks">Top Tracks</SelectionButton>
									<SelectionButton value="artists">Top Artist</SelectionButton>
								</SelectionGroup>

								<SelectionGroup
									value={timeSelected}
									exclusive
									onChange={(event, newTimeSelection) => {
									...
									<SelectionButton value="long_term">All Time</SelectionButton>
								</SelectionGroup>
							</Stack>
