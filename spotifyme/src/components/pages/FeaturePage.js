				...
				style={{
					...
					<ICard
						...
						<FeatureGrid
							...
							aria-label="feature"
							>
							<StyledButton value="acousticness" style={{backgroundColor: '#B08968'}}>
							Acousticness
							</StyledButton>

							<StyledButton value="danceability" style={{backgroundColor: '#5390D9'}}>
							Danceability
							</StyledButton>

							<StyledButton value="energy" style={{backgroundColor: '#FF9100'}}>
							Energy
							</StyledButton>

							<StyledButton value="tempo" style={{backgroundColor: '#F15156'}}>
							Tempo
							</StyledButton>

							<StyledButton value="valence" style={{backgroundColor: '#8A41FB'}}>
							Valence
							</StyledButton>

							<StyledButton value="length" style={{backgroundColor: '#9A8C98'}}>
							Length
							</StyledButton>

							<StyledButton value="popularity" style={{backgroundColor: '#FF758F'}}>
							Popularity
							</StyledButton>

							<StyledButton value="loudness" style={{backgroundColor: '#2D6A4F'}}>
							Loudness
							</StyledButton>
						</FeatureGrid>
					</ICard>
